...
class TestRobotService:
    ...
    def test_performance_response_time(self, client, performance_thresholds):
        ...
        p95_threshold = performance_thresholds.get('response_time', {}).get('p95', 500)  # ms
        ...
        assert p95_time < p95_threshold, f"P95 response time {p95_time}ms exceeds threshold {p95_threshold}ms"